...
class UserPermissionsSeeder_1 extends Seeder
{
    ...
    public function run()
    {
        ...
        // ...
        Apiato::call('Authorization@CreatePermissionTask', ['search-users', 'Find a User in the DB.', '', 'api']);
        Apiato::call('Authorization@CreatePermissionTask', ['list-users', 'Get All Users.', '', 'api']);
        Apiato::call('Authorization@CreatePermissionTask', ['update-users', 'Update a User.', '', 'api']);
        Apiato::call('Authorization@CreatePermissionTask', ['delete-users', 'Delete a User.', '', 'api']);
        Apiato::call('Authorization@CreatePermissionTask', ['refresh-users', 'Refresh User data.', '', 'api']);
