...
use App\Containers\Accounting\Data\Criterias\FilterJobTypeCriteria;
...
class GetHoursTask extends Task
{
    ...
    public function run($params)
    {
        ...
        if(isset($params['job_type_id'])) {
            $this->repository->pushCriteria(new FilterJobTypeCriteria($params['job_type_id']));
        }
        ...
        try {
            ...
            $rows =  $this->repository->get()->toArray();
